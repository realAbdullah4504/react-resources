...
const ConsultationButton = () => {
  ...
  return (
    <>
      <button
        onClick={() => {
          addLog('👤 User clicked "Consultation Accepted" button');
          setShowDialog(true);
        }}
        style={{
          padding: '10px 20px',
      ...
      {showDialog && (
        <div style={{
          ...
          <h3>Consultation Accepted - Are you sure?</h3>
          <p>If you click Yes, the journey will close.</p>
          ...
          <div style={{ marginTop: '20px', display: 'flex', gap: '10px' }}>
            ...
            <button
              onClick={() => {
                addLog('👤 User clicked "No" in consultation dialog');
                setShowDialog(false);
              }}
              style={{
                flex: 1,
